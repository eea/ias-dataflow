  ...
  <div class="wrapper">
    ...
    <b-modal size="lg" style="text-align:left" ref="errorsModal" hide-footer title="Errors">
      <b-card v-if="sectionAErrors.length">
        <h4 class="errorSectionTitle" @click="changeDirection('sectionAChevron')" v-b-toggle.SectionAErrors>
          <b-badge style="font-size:inherit; width: 100%" variant="danger"><i ref="sectionAChevron"
                                                                              class="fas fa-chevron-right"></i> Section
            A
          </b-badge>
        </h4>
        <b-collapse id="SectionAErrors">
          <b-list-group>
            <b-list-group-item v-for="(error, error_index) in sectionAErrors" :key="`A_${error_index}`">
              <h6>
                <a @click="clickSectionA(error.EASINCode)" :href="`#${error.sci_name}`">{{error.sci_name}} <span
                  style="float:right">{{error.EASINCode}}</span></a>
              </h6>
              <ul class="listing">
      ...
      <b-card v-if="sectionBErrors.length">
        <h4 class="errorSectionTitle" @click="changeDirection('sectionBChevron')" v-b-toggle.SectionBErrors>
          <b-badge style="font-size:inherit; width: 100%" variant="danger"><i ref="sectionBChevron"
                                                                              class="fas fa-chevron-right"></i> Section
            B
          </b-badge>
        </h4>
      ...
      <b-card v-if="sectionCErrors.length">
        <h4 class="errorSectionTitle" @click="changeDirection('sectionCChevron')" v-b-toggle.SectionCErrors>
          <b-badge style="font-size:inherit; width: 100%" variant="danger"><i ref="sectionCChevron"
                                                                              class="fas fa-chevron-right"></i> Section
            C
          </b-badge>
        </h4>
      ...
      return {
        ...
        jsonemptyinstance: {
          "IAS": {
            ...
            "@xsi:schemaLocation": "http://dd.eionet.europa.eu/namespaces/884  http://dd.eionet.europa.eu/v2/dataset/3426/schema-dst-3426.xsd",
            "inspectionsPermitsReported": {
