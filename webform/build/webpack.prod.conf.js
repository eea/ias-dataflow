...
var webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([
      {
        from: path.resolve(__dirname, '../static/biogeographical_regions'),
        ...
        to: config.build.assetsSubDirectory,
        ignore: ['.*','files.json','prefill.json', 'biogeographical_regions', 'marine_subregions', 'nuts_regions', 'river_basins', 'speciesb']
      },{
        from: path.resolve(__dirname, '../dist-example'),
        to: config.build.assetsSubDirectory,
        ignore: ['.*','*.js','*.css','*.zip','*.html','*.json']
      }
    ])
  ]
})
